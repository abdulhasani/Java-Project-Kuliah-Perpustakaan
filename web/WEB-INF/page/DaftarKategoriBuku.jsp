                                    ...
                                    <tr>
                                            ...
                                            <form id="form1" name="form1" method="post" action="">
                                                <center>
                                                    ...
                                                    <table width="406" height="109" border="1">
                                                        <tr valign="top">
                                                            <td width="396"><table width="387" border="0" style="width: 400px; height: 193px;">
                                                              <tbody>
                                                                <tr valign="top">
                                                                    <td width="377" style="width: 282px; background-color: rgb(239,239,239);" valign="top"><br />
                                        ...
                                        <td valign="top" width="575"><div align="center"><br />
                                          <table width="559" border="0" cellpadding="0" cellspacing="2" style="width: 553px; height: 62px;">
                                            <tbody>
                                              <tr>
                                                <td align="center" valign="top" width="555"><font style="color: #000000;" size="+1">DAFTAR KATEGORI BUKU<br />
                                                  </font>
                                                  <div style="text-align: left;">
                                                    <table width="552" height="46" border="1">
                                                      ...
                                                      <tr>
                                                        ...
                                                        <san:forEach items="${kategoriBuku}" var="kat">
                                                          <tr>
                                                            <td width="151" style="color:#000000" ><div align="left">${kat.nama}</div></td>
                                                            <td width="223" style="color:#000000"><div align="left">${kat.keterangan}</div></td>
                                                            <td width="137" style="color:#000000"><div align="center"><a href="controler?/san/jmat/perpus/action=crudKategoriBuku&idKtgBuku=${kat.idKategoriBuku}">EDIT</a><a href="controler?/san/jmat/perpus/action=deleteKategoriBuku&idKtgBuku=${kat.idKategoriBuku}">&nbsp;DELETE</a></div></td>
                                                            </tr>
                                                          </san:forEach>
                                                        <tr>
                                                            <td colspan="3"><div align="center"><a href="controler?/san/jmat/perpus/action=crudKategoriBuku&idKtgBuku="><font color="blue">ADD</font></a></div></td>
                                                        </tr>
