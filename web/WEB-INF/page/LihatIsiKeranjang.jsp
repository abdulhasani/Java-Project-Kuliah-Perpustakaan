                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="center" valign="top" width="519"> <font color="yellow"><font style="color: yellow;" size="+1"><span style="font-family: Nimbus Sans L;">PERPUSTAKAAN
                                                            ...
                                                            <div style="text-align: left; color: #FF0;">
                                                                <form id="form2" name="form2" method="post" action="controler?/san/jmat/perpus/action=resetKeranjang">
                                                                    <table width="539" border="1">
                                                                        <tr>
                                                                            <td width="136"><div align="center"><strong>ID BUKU</strong></div></td>
                                                                            <td width="358"><div align="center"><strong>JUDUL BUKU</strong></div></td>
                                                                        </tr>
                                                                        <san:forEach items="${keranjang.detilPeminjamans}" var="detilPeminjaman">
                                                                            <tr>
                                                                                <td><div align="center">${detilPeminjaman.bukuId.idBuku}</div></td>
                                                                                <td><div align="center">${detilPeminjaman.bukuId.judul}</div></td>
                                                                            </tr>
                                                                        </san:forEach>
                                                                        <tr>
                                                                            <td>&nbsp;</td>
