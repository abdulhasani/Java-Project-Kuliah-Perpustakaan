                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top" width="519"> <font color="yellow"><font style="color: yellow;" size="+1"><span style="font-family: Nimbus Sans L;">PERPUSTAKAAN
                                                            ...
                                                            <div style="text-align: left;">
                                                                 <form action="controler?/san/jmat/perpus/action=simpanBiayaPeminjaman" method="post">
                                                                   <div align="center">
                                                                     <table width="445" border="0" style="color:#FF0">
                                                                       <san:if test="${pesan!=null}">
                                                                         <tr>
                                                                           <td colspan="3" > <div align="center" style="color: red"><font size="+1">${pesan}</font></div> </td>
                                                                           </tr>
                                                                         </san:if>
                                                                         <san:if test="${kembalian==null}">
                                                                       <tr>
                                                                         <td width="122">Nomor Anggota</td>
                                                                         <td width="9"><div align="center">:</div></td>
                                                                         <td width="300"><label for="nama">${nomorAnggota}</label></td>
                                                                         </tr>
                                                                         <tr>
                                                                         <td width="122">Jumlah Item</td>
                                                                         <td width="9"><div align="center">:</div></td>
                                                                         <td width="300"><label for="nama">${jumlahItem}</label></td>
                                                                         </tr>
                                                                       <tr>
                                                                         <td width="122">Biaya Peminjaman</td>
                                                                         <td width="9"><div align="center">:</div></td>
                                                                         <td width="300"><label for="nama">Rp. ${biaya}</label></td>
                                                                         </tr>
                                                                       <tr>
