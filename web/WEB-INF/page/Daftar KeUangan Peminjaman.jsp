                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" width="763"><br />
                                            <table width="723" border="0" cellpadding="0" cellspacing="2" style="width: 553px; height: 62px;">
                                                <tbody>
                                                    <tr>
                                                        <td align="center" valign="top" width="719"><font style="color: #000000;" size="+1">DAFTAR KEUANGAN PEMINAJAMAN BUKU<br />
                                                            </font>
                                                            <div style="text-align: left;">
                                                                <table width="755" height="210" border="1">
                                                                    <form id="form2" name="form2" method="post" action="controler?/san/jmat/perpus/action=searchDaftarKeUanganPeminjaman">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="color:#000000"><div align="center">TANGGAL PEMASUKAN</div></td>
                                                                        <td style="color:#000000"><div align="center">JUMLAH ITEM</div></td>
                                                                        <td style="color:#000000"><div align="center">UANG PEMASUKAN</div></td>
                                                                        
                                                                    </tr>
                                                                    <san:if test="${msg==null}">
                                                                        <san:set var="sum" value="${0}"/>
                                                                        <san:forEach items="${keuanganPmj}" var="keungan">
                                                                            <tr>
                                                                                <td width="233" style="color:#000000" ><div align="left">${keungan.nomorAnggota}</div></td>
                                                                                <td width="136" style="color:#000000"><div align="center">${keungan.tanggalPemasukan}</div></td>
                                                                                <td width="102" style="color:#000000"><div align="center">${keungan.jumlahItem}</div></td>
                                                                                <td width="174" style="color: #000000"><div align="center"><fmt:formatNumber value="${keungan.nominalPemasukan}" currencySymbol="Rp." type="currency"/></div></td>
                                                                            </tr>
                                                                            <san:set var="sum" value="${sum+keungan.nominalPemasukan}" />
                                                                        </san:forEach>
                                                                    </san:if>
                                                                    
                                                                        <tr>
                                                                          <td colspan="4" style="color:#FF0000; font-weight: bold;" ><div align="right">TOTAL UANG PEMASUKAN = Rp. ${sum}</div></td>
                                                                        </tr>
                                                                        <tr>
                                                                          <td colspan="4" style="color:#FF0000; font-weight: bold;" ><div align="right">TOTAL UANG PEMINJAMAN = Rp. ${total}</div></td>
                                                                  </tr>
                                                                        <tr>
                                                                            <td colspan="4" style="color:#FF0000" ><div align="center"><a href="controler?/san/jmat/perpus/action=deleteDaftarKeUanganPeminjaman"><strong>DELETE ALL</strong></a></div></td>                                                                            
                                                                        </tr>
                                                                    
                                                                    <san:if test="${msg!=null}">
                                                                        <tr>
                                                                            <td colspan="4" style="color: firebrick" ><div align="center"><strong>${msg}</strong></div></td>
                                                                        </tr>
                                                                    </san:if>
                                                                </table>
