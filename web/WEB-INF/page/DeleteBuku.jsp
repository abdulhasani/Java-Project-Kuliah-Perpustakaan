                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top" width="519"> <font color="yellow"><font style="color: yellow;" size="+1"><span style="font-family: Nimbus Sans L;">PERPUSTAKAAN
                                                            ...
                                                            <div style="text-align: left;">
                                                                <form action="controler?/san/jmat/perpus/action=deleteBukuFinish&hapus=${buku.idBuku}" method="post">
                                                                    <table width="445" border="0" style="color:#FF0">
                                                                        <san:if test="${msg2!=null}">
                                                                                <tr>
                                                                                    <td colspan="3" style="color: red">${msg2}</td>
                                                                                </tr>
                                                                    </san:if>
                                                                    <tr>
                                                                        <td>Id Buku</td>
                                                                    ...
                                                                    <tr>
                                                                        <td>&nbsp;</td>
                                                                        <td><div align="center"></div></td>
                                                                        <td><input type="submit" name="Submit" id="button" value="Delete" /></td>
                                                                    </tr>
                                                                </table>
                                                            </form>
