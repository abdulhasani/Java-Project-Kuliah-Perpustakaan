                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top" width="519"> <font color="yellow"><font style="color: yellow;" size="+1"><span style="font-family: Nimbus Sans L;">PERPUSTAKAAN
                                                            ...
                                                            <div style="text-align: left;">
                                                                <form action="controler?/san/jmat/perpus/action=simpanBukuFinish&idBk=${seleksi}" method="post">
                                                                    <table width="445" border="0" style="color:#FF0">
                                                                        <san:if test="${msg2!=null}">
                                                                            <tr>
                                                                                <td colspan="3"><div align="center"><font color="red">${msg2}</font></div></td>
                                                                            </tr>
                                                                        </san:if>
                                                                        <san:if test="${seleksi!=null}">
                                                                            <tr>
                                                                                ...
                                                                                <td><input name="idBuku" type="text" id="tahunTerbit2" disabled="disabled" size="10" maxlength="11" value="${seleksi}"/></td>
                                                                            </tr>
                                                                        </san:if>
                                                                        <tr>
                                                                            <td width="122">Judul Buku</td>
                                                                            <td width="9"><div align="center">:</div></td>
                                                                            <td width="300"><label for="judulBuku"></label>
                                                                                <input name="judulBuku" type="text" id="judulBuku" maxlength="50" size="35" value="${Buku.judul}"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Pengarang</td>
                                                                            <td><div align="center">:</div></td>
                                                                            <td><label for="pengarang"></label>
                                                                                <input name="pengarang" type="text" id="pengarang" size="35" maxlength="50" value="${Buku.pengarang}"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Penerbit</td>
                                                                            <td><div align="center">:</div></td>
                                                                            <td><label for="penerbit"></label>
                                                                                <input name="penerbit" type="text" id="penerbit" maxlength="50" size="35" value="${Buku.penerbit}"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Tahun Terbit</td>
                                                                            <td><div align="center">:</div></td>
                                                                            <td><label for="tahunTerbit"></label>
                                                                                <input name="tahunTerbit" type="text" id="tahunTerbit" size="10" maxlength="5" value="${Buku.tahunTerbit}"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Kategori</td>
                                                                            <td><div align="center">:</div></td>
                                                                            <td><label for="select"></label>
                                                                                <select name="kategoriBukuId" id="select">
                                                                                    <option value="0">Pilih Kategori</option>
                                                                                    <san:forEach items="${kategoriBuku}" var="katBuku">
                                                                                        <option value="${katBuku.idKategoriBuku}">${katBuku.nama}</option>
                                                                                    </san:forEach>
                                                                        ...
                                                                        <tr>
                                                                            <td>Jumlah Stok</td>
                                                                            <td><div align="center">:</div></td>
                                                                            <td><input name="jumlahStok" type="text" id="jumlahStok" size="10" maxlength="11" value="${Buku.jumlahStok}"/></td>
                                                                        </tr>

                                                                        <tr>
                                                                            <td>Jumlah Tersedia</td>
                                                                            <td><div align="center">:</div></td>
                                                                            <td><input name="jumlahTersedia" type="text"  id="jumlahTersedia" size="10" maxlength="11" value="${Buku.jumlahTersedia}"/></td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><label for="keterangan"></label>
                                                                                <textarea name="keterangan" id="keterangan" cols="45" rows="5" >${Buku.keterangan}</textarea></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Sinopsis</td>
                                                                            <td><div align="center">:</div></td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><label for="sinopsis"></label>
                                                                                <textarea name="sinopsis" id="sinopsis" cols="45" rows="5">${Buku.sinopsis}</textarea></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>&nbsp;</td>
                                                                            <td><div align="center"></div></td>
                                                                            <td><input type="submit" name="Submit" id="button" value="Simpan" />
                                                                                <san:if test="${seleksi==null}"><input type="reset" name="button2" id="button2" value="Bersihkan" /></san:if></td>
                                                                        </tr>
                                                                    </table>
                                                                </form>
