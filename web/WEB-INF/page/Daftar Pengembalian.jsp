                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" width="763"><br />
                                            <table width="723" border="0" cellpadding="0" cellspacing="2" style="width: 553px; height: 62px;">
                                                <tbody>
                                                    <tr>
                                                        <td align="center" valign="top" width="719"><font style="color: #000000;" size="+1">DAFTAR PENGEMBALIAN<br />
                                                            </font>
                                                            <div style="text-align: left;">
                                                                <table width="755" height="210" border="1">
                                                                    <form id="form2" name="form2" method="post" action="controler?/san/jmat/perpus/action=searchPengembalian">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="color:#000000"><div align="center">DIKEMBALIKAN TANGGAL</div></td>
                                                                        <td style="color:#000000"><div align="center">BUKU YANG DIPINJAM</div></td>
                                                                        <td style="color:#000000"><div align="center">DELETE</div></td>
                                                                    </tr>
                                                                    <san:if test="${msg==null}">
                                                                        <san:forEach items="${pengembalian}" var="pengembalian">
                                                                            <tr>
                                                                                <td width="133" style="color:#000000" ><div align="left">${pengembalian.nomorAnggota}</div></td>
                                                                                <td width="128" style="color:#000000"><div align="center"><fmt:formatDate value="${pengembalian.ketentuanTglKembali}" type="date" /></div></td>
                                                                                <td width="140" style="color:#000000"><div align="center"><fmt:formatDate value="${pengembalian.tglKembali}" type="date" /></div></td>
                                                                                <td width="202" style="color: #000000"><div align="left">${pengembalian.judulBuku}</div></td>
                                                                                <td width="118" style="color:#000000"><div align="center"><a href="controler?/san/jmat/perpus/action=deleteDaftarPengembalian&id=${pengembalian.id}">YES</a></div></td>
                                                                            </tr>
                                                                        </san:forEach>
                                                                    </san:if>
                                                                    
                                                                        <tr>
                                                                            <td colspan="5" style="color:#FF0000" ><div align="center"><a href="controler?/san/jmat/perpus/action=deleteDaftarPengembalian"><strong>DELETE ALL</strong></a></div></td>                                                                            
                                                                        </tr>
                                                                    
                                                                    <san:if test="${msg!=null}">
                                                                        <tr>
                                                                            <td colspan="5" style="color: firebrick" ><div align="center"><strong>${msg}</strong></div></td>
                                                                        </tr>
                                                                    </san:if>
                                                                </table>
