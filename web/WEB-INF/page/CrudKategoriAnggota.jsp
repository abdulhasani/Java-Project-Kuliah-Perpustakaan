                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top" width="519"> <font color="yellow"><font style="color: yellow;" size="+1"><span style="font-family: Nimbus Sans L;">PERPUSTAKAAN
                                                            ...
                                                            <div style="text-align: left;">
                                                                 <form action="controler?/san/jmat/perpus/action=simpanKategoriAnggotaFinish&katAnggotaId=${kategoriAnggota.idKategoriAnggota}" method="post">
                                                                   <div align="center">
                                                                     <table width="445" border="0" style="color:#FF0">
                                                                       ...
                                                                       <tr>
                                                                         <td>&nbsp;</td>
                                                                         <td>&nbsp;</td>
                                                                         <td><input type="hidden" name="idKategoriBuku" id="idKategoriBuku" value="${kategoriAnggota.idKategoriAnggota}" /></td>
                                                                         </tr>
                                                                       <tr>
                                                                         <td width="122">Nama</td>
                                                                         <td width="9"><div align="center">:</div></td>
                                                                         <td width="300"><label for="nama"></label>
                                                                           <input name="nama" type="text" id="nama" maxlength="30" size="35" value="${kategoriAnggota.nama}"/></td>
                                                                         </tr>
                                                                       <tr>
                                                                         <td>Keterangan</td>
                                                                       ...
                                                                       <tr>
                                                                         <td></td>
                                                                         <td></td>
                                                                         <td><textarea name="keterangan" id="keterangan" cols="45" rows="5">${kategoriAnggota.keterangan}</textarea></td>
                                                                         </tr
                                                                    >
                                                                       <tr>
                                                                         <td>&nbsp;</td>
